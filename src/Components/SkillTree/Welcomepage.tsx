...
const Welcomepage = () =>{
    return(<div className="flex flex-col h-screen">
        <div className="mt-16 md:mt-24 md:mb-10 flex justify-center md:justify-start md:ml-10">
        ...
        <div className="flex flex-col items-center justify-center">
            ...
            <div className="flex flex-col md:flex-row md:space-x-20">
                <div className=" mt-8 w-80 h-80 border-1 border-black rounded-xl flex flex-col items-center space-y-6 shadow-sharp-md hover:shadow-sharp-lg icon-hover3 cursor-default">
